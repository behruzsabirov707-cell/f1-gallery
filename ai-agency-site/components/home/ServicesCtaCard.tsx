...
export default function ServicesCtaCard({
  ...
  return (
    ...
    >
      <span className="flex h-11 w-11 items-center justify-center rounded-tr-2xl rounded-bl-2xl rounded-tl-md rounded-br-md border border-(--color-signal)/40 bg-(--color-bg-elevated) transition-transform duration-300 group-hover:scale-110">
        <ArrowUpRight
          className="h-5 w-5 text-(--color-signal)"
          strokeWidth={1.75}
        />
      </span>
